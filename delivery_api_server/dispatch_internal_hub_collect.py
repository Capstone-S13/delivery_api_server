...
class TaskRequester(Node):
    ...
    def __init__(self, argv=sys.argv):
        ...
        parser.add_argument('-u', '--unit', required=True,
                            type=str, help='Unit waypoint to deposit parcel')
        ...
        description["category"] = "internal_hub_collect"
        description["phases"] = []
        activities = []
        activities.append({"category": "go_to_place",  "description": self.args.hub})
        activities.append({"category": "perform_action",  "description": {"unix_millis_action_duration_estimate": 60000, "category": "hub_collect", "description": {"id": "id", "description": "desc"}}})
        activities.append({"category": "go_to_place",  "description": self.args.unit})
        activities.append({"category": "perform_action",  "description": {"unix_millis_action_duration_estimate": 60000, "category": "unit_deposit", "description": {"unit": self.args.unit}}})
