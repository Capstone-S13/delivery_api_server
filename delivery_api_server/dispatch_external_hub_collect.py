...
class TaskRequester(Node):
    ...
    def __init__(self, argv=sys.argv):
        ...
        description["category"] = "external_hub_collect"
        description["phases"] = []
        activities = []
        activities.append({"category": "go_to_place",  "description": self.args.hub})
        activities.append({"category": "perform_action",  "description": {"unix_millis_action_duration_estimate": 60000, "category": "hub_collect", "description": {}}})
