...
class TaskRequester(Node):
    ...
    def __init__(self, argv=sys.argv):
        ...
        description["category"] = "internal_hub_deposit"
        description["phases"] = []
        activities = []
        activities.append({"category": "go_to_place",  "description": self.args.store})
        activities.append({"category": "perform_action",  "description": {"unix_millis_action_duration_estimate": 60000, "category": "store_collect", "description": {"store": self.args.store}}})
        activities.append({"category": "go_to_place",  "description": self.args.hub})
        activities.append({"category": "perform_action",  "description": {"unix_millis_action_duration_estimate": 60000, "category": "hub_deposit", "description": {"id": "id", "description": "desc"}}})
